...
/* Wait for storage resume while paused */
extern size_t wait_for_storage_resume_paused(void** req);
/* Wait for permanent IPRE resume while paused */
extern size_t wait_for_permanent_ipre_resume_paused(void** req);
 ...
 * a content type. The response is sent back to the client.
 */
static inline void
...
/* Fetch content from provided URL. Content will be allocated with mmap
...
asm(".global wait_for_storage_resume_paused\n"
	".type wait_for_storage_resume_paused, @function\n"
	"wait_for_storage_resume_paused:\n"
	".cfi_startproc\n"
	"	mov $0x10002, %eax\n"
	"	out %eax, $0\n"
	"   wrfsbase %rdi\n"
...
asm(".global wait_for_permanent_ipre_resume_paused\n"
	".type wait_for_permanent_ipre_resume_paused, @function\n"
	"wait_for_permanent_ipre_resume_paused:\n"
	".cfi_startproc\n"
	"	mov $0x10002, %eax\n"
	"	out %eax, $0\n"
	"	ret\n"
...
asm(".global sys_storage_resume\n"
	".type sys_storage_resume, @function\n"
	"sys_storage_resume:\n"
	"	mov $0x1070B, %eax\n"
	"	out %eax, $0\n"
	"   ret\n");
